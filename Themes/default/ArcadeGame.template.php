	...
	<div class="cat_bar">
		<h3 class="catbg">
			<a href="', $scripturl, '?index.php;action=arcade;sa=play;game=', $context['game']['id'], '" title="', $txt['arcade_play'],' ', $context['game']['name'], '">
				<span class="floatleft" style="font-size: 0.8em;">', $context['game']['name'], '</span>
			</a>',
			(version_compare((!empty($modSettings['smfVersion']) ? substr($modSettings['smfVersion'], 0, 3) : '2.0'), '2.1', '<') ? '
			<img id="game_toggle" class="floatright" src="' . $settings['images_url'] . '/collapse.gif' . '" alt="" title="' . $txt['upshrink_description'] . '" style="margin: 0 1ex; display: none;vertical-align: bottom;" />' : '
			<span id="game_toggle" class="floatright' . (empty($options['game_panel_collapse']) ? ' toggle_up' : ' toggle_down') . '" title="' . $txt['upshrink_description'] . '" style="margin: 0; vertical-align: bottom;"></span>'), '
		</h3>
	</div>
