						...
						<tr class="catbg">
							<th scope="col" class="lefttext first_th" width="40%">
								...
								<span style="padding-left: 5%;">
									<a href="', $scripturl, '?action=arcade;sa=online;start=', $context['start'], ';show=', $context['show_by'], ';sort=user;', $context['join'] != 'disjoin' && $context['sort_by'] == 'user' ? 'join=disjoin;' : ($context['sort_by'] == 'user' ? 'join=join;' : ''), $context['sort_direction'] != 'down' && $context['sort_by'] == 'user' ? 'asc' : '', '" rel="nofollow">', $txt['arcade_coalesce'], ' ', $context['sort_by'] == 'user' ? '<img src="' . $settings['images_url'] . '/sort_' . ($context['join'] != 'disjoin' ? 'up' : 'down') . '.gif" alt="" />' : '', '</a>
								</span>
							</th>
